...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_2_router.sv \
  ...
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_1_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_1_router.sv \
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_0_avalon_st_adapter.v \
  ...
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_0_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_0_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_0_cmd_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_0_router_001.sv \
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_0_router.sv \
  ...
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_irq_mapper.sv \
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_2.v \
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_1.v \
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_mm_interconnect_0.v \
  ...
  $QSYS_SIMDIR/submodules/pcie_cv_qsys_onchip_memory2_0.v \
